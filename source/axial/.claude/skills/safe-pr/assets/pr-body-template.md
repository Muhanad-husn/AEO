...
- [ ] The sprint suite (src units + this sprint's acceptance directory) is green locally, and CI is green for everything else.
- [ ] If this touches a module shared across phases (`llm.py`, `cli.py`, config loading), that is called out below and CI is green before approval is requested.
