...
```
$ axial schema validate config/domains/syria
axis field: consistent
axis claim_type: consistent
axis empirical_scope: consistent
axis theory_school: consistent
axis artifact_role: consistent
axis role_in_argument: consistent
exit=0

$ axial schema validate tests/fixtures/codebook_missing_tag
error: schema tag 'gamma' on axis 'topic' has no codebook entry
exit=1

$ axial schema validate tests/fixtures/codebook_extra_tag
error: codebook tag 'delta' on axis 'topic' is not declared by the schema
exit=1
```

Full transcript: [`docs/tdd-evidence/schema-loader/03-codebook-validate/cli-demo.txt`](https://github.com/Muhanad-husn/axial/blob/f6b822e8617959e2e64cb623a5b083c36e83d2ca/docs/tdd-evidence/schema-loader/03-codebook-validate/cli-demo.txt)
...
Full transcript: [`docs/tdd-evidence/schema-loader/03-codebook-validate/test-run.txt`](https://github.com/Muhanad-husn/axial/blob/f6b822e8617959e2e64cb623a5b083c36e83d2ca/docs/tdd-evidence/schema-loader/03-codebook-validate/test-run.txt)

_All evidence committed under `docs/tdd-evidence/schema-loader/03-codebook-validate/`._
